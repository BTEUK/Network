...
public record Constants(String serverName, ServerType serverType, boolean regionsEnabled, long regionInactivity, boolean tpllEnabled, int maxY, int minY, String earthWorld, boolean customMessages,
